...
int main()
{
    ...
    //set icon
    sf::Image icon;
    if(!icon.loadFromFile( R"(C:\Users\franc\CLionProjects\RPG_game\Resources\role-playing-game.png )"))/*C:\Users\erosp\Desktop\RPG_game\Resources\role-playing-game.png*/
        return EXIT_FAILURE;
    window.setIcon(icon.getSize().x, icon.getSize().y, icon.getPixelsPtr());

    //background texture
    sf::Texture textureBackground;
    if(!textureBackground.loadFromFile(R"(C:\Users\franc\CLionProjects\RPG_game\Resources\Rpg.textureSfondo.jpg)"))/*C:\Users\erosp\Desktop\RPG_game\Resources\Rpg.textureSfondo.jpg*/
        return EXIT_FAILURE;
    ...
    //text texture
    sf::Font font;
    if(!font.loadFromFile( R"(C:\Users\franc\CLionProjects\RPG_game\Resources\SuperLegendBoy-4w8Y.ttf)"))/*C:\Users\erosp\Desktop\RPG_game\Resources\SuperLegendBoy-4w8Y.ttf*/
        return EXIT_FAILURE;

    //Hero texture
    sf::Texture textureHero;
    if(!textureHero.loadFromFile(R"(C:\Users\franc\CLionProjects\RPG_game\Resources\Rpg.textureHero.png)"))/*C:\Users\erosp\Desktop\RPG_game\Resources\Rpg.textureHero.png*/
        return EXIT_FAILURE;

    //enemy texture
    sf::Texture textureEnemy;
    if(!textureEnemy.loadFromFile(R"(C:\Users\franc\CLionProjects\RPG_game\Resources\UnHero.png)"))/*C:\Users\erosp\Desktop\RPG_game\Resources\UnHero.png*/
        return EXIT_FAILURE;

    //Bullet texture
    sf::Texture textureAoeBullet;
    if(!textureAoeBullet.loadFromFile(R"(C:\Users\franc\CLionProjects\RPG_game\Resources\Projectiles_preview_rev_1.png)"))/*C:\Users\erosp\Desktop\RPG_game\Resources\Projectiles_preview_rev_1.png*/
        return EXIT_FAILURE;
